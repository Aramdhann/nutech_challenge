...
import { addUser, removeUser } from "../redux/olshopSlice";
import { useNavigate } from "react-router-dom";
import { googleLogo } from "../assets";

const Login = () => {
    // ini untuk menampilkan tombol login
    const userInfo = useSelector((state) => state.olshop.userInfo); // state.bazar.userInfo ini diambil dari reducers/index.js
    ...
    const handleLogin = () => {
        signInWithPopup(
            ...
            .then((result) => {
                // signed in pengguna info dari google
